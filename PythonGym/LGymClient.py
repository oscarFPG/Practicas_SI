...
import time
from Agent__IA.Controller import Controller
        ...
        if client.addCustomAgent(agent.Id(),agentName):
            ...
            if client.commandInit():
                ...
                while not finish:
                    ...
                    client._controller.recibirEntorno(perception, gameover, destroyed)
                    if gameover == True:
                        finish = True
                        win = True
                        if debug :
                        ...
                        action, fire = client._controller.reaccionar()
                        if client.SendAction(["movement","fire"],[str(action), fire]) :
                            if debug :
